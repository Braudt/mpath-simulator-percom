...
NAME="Random Wifi Delay (std 100%)"
...
wifilink=RandomLink("WiFi",100000000.,0, 1.85,1.85,100000000.,0, 1.85,1.85)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,0, 1.85+cd,1.85,100000000.,0, 1.85+cd,1.85)
