...
NAME="Random Wifi Delay (std 500%)"
...
wifilink=RandomLink("WiFi",100000000.,0, 1.85,1.85*5,100000000.,0, 1.85,1.85*5)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,0, 1.85+cd,1.85*5,100000000.,0, 1.85+cd,1.85*5)
