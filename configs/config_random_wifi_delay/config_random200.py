...
NAME="Random Wifi Delay (std 200%)"
...
wifilink=RandomLink("WiFi",100000000.,0, 1.85,1.85*2,100000000.,0, 1.85,1.85*2)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,0, 1.85+cd,1.85*2,100000000.,0, 1.85+cd,1.85*2)
