...
ltelink=RandomLink("LTE",30000000.,15000000, 9.95,1.29, 30000000.,15000000, 9.95,1.29)
ltecloudlink=RandomLink("LTE2Cloud",30000000.,15000000, 9.95+cd,1.29, 30000000.,15000000, 9.95+cd,1.29)
wifilink=RandomLink("WiFi",100000000.,50000000, 1.85,1.20,100000000.,50000000, 1.85,1.20)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,50000000, 1.85+cd,1.20,100000000.,50000000, 1.85+cd,1.20)
...
combinations=[(d2dlink,device1),
        ...
        (ltecloudlink,cloud2),
        (ltecloudlink,cloud3),
        (wificloudlink,cloud1),
        (wificloudlink,cloud2),
        (wificloudlink,cloud3),
        ]
