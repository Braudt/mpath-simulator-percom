...
NAME="Random Wifi Delay (std 87.5%)"
...
wifilink=RandomLink("WiFi",100000000.,87500000, 1.85,0,100000000.,87500000, 1.85,0)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,87500000, 1.85+cd,0,100000000.,87500000, 1.85+cd,0)
