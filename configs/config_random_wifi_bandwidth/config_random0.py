...
NAME="Random Wifi Bandwidth (std 0%)"
...
wifilink=RandomLink("WiFi",100000000.,0, 1.85,0,100000000.,0, 1.85,0)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,0, 1.85+cd,0,100000000.,0, 1.85+cd,0)
