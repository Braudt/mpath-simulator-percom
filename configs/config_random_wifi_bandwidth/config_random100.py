...
NAME="Random Wifi Bandwidth (std 100%)"
...
wifilink=RandomLink("WiFi",100000000.,100000000, 1.85,0,100000000.,100000000, 1.85,0)
wificloudlink=RandomLink("WiFi2Cloud",100000000.,100000000, 1.85+cd,0,100000000.,100000000, 1.85+cd,0)
