...
def plot_deadlines(statsdict):
    ...
    axes.set_xlabel('WiFi one way latency (ms)',**axis_font)
...
def plot_load(statsdict):
    ...
    axes.set_xticks(ind)
    axes.set_xticklabels(['0', '2.5', '5', '7.5', '10','12.5','15','17.5','20'],
...
def main():
    ...
    module="config_wifi"
    importname="configs.config_wifi_delay."+module

    cloud_lat=["0","2-5","5","7-5","10","12-5","15","17-5","20"]
