...
def plot_deadlines(statsdict):
    ...
    x=[1,2.5,5,7.5,10,25,50,75,100]
    ind = np.arange(N)    # the x locations for the groups

    plt1=axes.plot(x,losses,color='indianred')
    axes.set_xlabel('WiFi Bandwidth (Mb/s)',**axis_font)
    ...
    cloud.savefig(os.getcwd() + "/figs/wifi_bandwidth_deadlines.pdf",format='pdf',bbox_inches = 'tight')
...
def plot_load(statsdict):
    ...
    axes.set_xticks(ind)
    axes.set_xticklabels(['1', '2.5', '5', '7.5', '10','25','50','75','100'],
            rotation=45,**axis_font)

#cloud.tight_layout()
    cloud.savefig(os.getcwd() + "/figs/wifi_bandwidth_load.pdf",format='pdf',bbox_inches = 'tight')
...
def main():
    ...
    module="config_wifi"
    importname="configs.config_wifi_bandwidth."+module

    cloud_lat=["1","2-5","5","7-5","10","25","50","75","100"]
